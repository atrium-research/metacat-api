...
def list_mappings(
    ...
    scheme_a = _scheme_of(vocab_a) if vocab_a else None
...
def vocabulary_overlap(vocab_a: str, vocab_b: str) -> VocabularyOverlap:
    scheme_a = _scheme_of(vocab_a)
    scheme_b = _scheme_of(vocab_b)
